...
$coreRoot = Join-Path $Root 'scripts/hooks/core'
...
try {
    ...
    $queryScript = Join-Path $Root 'scripts/query-hook-audit.ps1'
    ...
    $viewScript = Join-Path $Root 'scripts/view-hook-trace.ps1'
