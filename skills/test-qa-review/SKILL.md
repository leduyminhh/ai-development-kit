---
name: test-qa-review
description: Use when acting as a QA reviewer agent for any language or stack, especially after architecture or implementation work, to derive test scenarios, inspect regression risk, choose verification commands, validate behavior against requirements, and report concise findings in English. Reserve automation-focused test generation and execution for a future test-automation-validate skill.
---
...
- `subagents/test-automation-review.md`: hand off gaps to `test-automation-validate` without generating tests directly.
