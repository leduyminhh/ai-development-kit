...
'@
    ...
    Assert-True (Test-Path -LiteralPath (Join-Path $tempRoot 'skills')) 'Validator -Fix should ensure Step 5 skills exists.'
    Assert-True (Test-Path -LiteralPath (Join-Path $tempRoot 'skills/manifest.toml')) 'Validator -Fix should ensure skills manifest exists.'
    Assert-True (Test-Path -LiteralPath (Join-Path $tempRoot 'skills/new-agent/subagents')) 'Validator -Fix should ensure Step 6 skill subagents exists.'
