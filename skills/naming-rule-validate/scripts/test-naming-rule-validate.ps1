...
try {
    ...
    New-Item -ItemType Directory -Path (Join-Path $tempRoot 'skills/diagram-generate/scripts') -Force | Out-Null
...
'@
    Set-Content -LiteralPath (Join-Path $tempRoot 'skills/diagram-generate/scripts/validate-diagram-layout.ps1') -Encoding utf8 -Value '# valid validation script'
    Set-Content -LiteralPath (Join-Path $tempRoot 'skills/diagram-generate/scripts/run-diagram-export.py') -Encoding utf8 -Value '# valid run script'
...
# Code Design Pattern
'@
    New-Item -ItemType Directory -Path (Join-Path $tempRoot 'skills/test-qa-review') -Force | Out-Null
    Set-Content -LiteralPath (Join-Path $tempRoot 'skills/test-qa-review/SKILL.md') -Encoding utf8 -Value @'
---
name: test-qa-review
...
'@
    ...
    New-Item -ItemType Directory -Path (Join-Path $tempRoot 'skills/agent-operating-rules') -Force | Out-Null
    Set-Content -LiteralPath (Join-Path $tempRoot 'skills/agent-operating-rules/SKILL.md') -Encoding utf8 -Value @'
---
...
'@
    ...
    & powershell -NoProfile -ExecutionPolicy Bypass -File $validator -Root $tempRoot -PathList '.codex/agents/java-review.toml|.codex/agents/code-design-pattern.toml|.codex/agents/security-code-review.toml|.codex/agent-metadata/java-review.toml|.codex/agent-metadata/code-design-pattern.toml|.codex/agent-metadata/security-code-review.toml|skills/java-review/SKILL.md|skills/java-review/subagents/java-api-contract-review.md|skills/java-review/subagents/skill-drift-review.md|skills/agent-operating-rules/SKILL.md|.codex/hooks/validate-workflow.ps1|scripts/run-workflow-validate.ps1|skills/diagram-generate/scripts/validate-diagram-layout.ps1|skills/diagram-generate/scripts/run-diagram-export.py|skills/workflow-validate/scripts/validate-workflow.ps1|skills/diagram-wireframe-generate/SKILL.md|skills/test-automation-validate/SKILL.md|skills/java-analyze/SKILL.md|skills/architecture-onion-design/SKILL.md|skills/code-design-pattern/SKILL.md|skills/test-qa-review/SKILL.md|skills/security-code-review/SKILL.md|workflows/workflow-java-architecture-review/WORKFLOW.md' | Out-Null
