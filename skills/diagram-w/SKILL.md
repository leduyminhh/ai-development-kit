...
- Interaction flow: `subagents/sequence-diagram-agent.md`
- User/system goals: `subagents/usecase-diagram-agent.md`
- Type/model structure: `subagents/class-diagram-agent.md`
- Runtime examples: `subagents/object-diagram-agent.md`
- Workflow/process: `subagents/activity-diagram-agent.md`
- Service/module boundaries: `subagents/component-diagram-agent.md`
- Infrastructure topology: `subagents/deployment-diagram-agent.md`
- Lifecycle/state changes: `subagents/state-diagram-agent.md`
- Time-based signal behavior: `subagents/timing-diagram-agent.md`
- Project schedule: `subagents/gantt-diagram-agent.md`
- Idea hierarchy: `subagents/mindmap-diagram-agent.md`
- Work breakdown: `subagents/wbs-diagram-agent.md`
- Structured data view: `subagents/json-yaml-diagram-agent.md`
- Network topology: `subagents/network-diagram-agent.md`
- UI wireframe: `subagents/wireframe-salt-agent.md`
- Enterprise architecture: `subagents/archimate-diagram-agent.md`
- Entity relationship or IE notation: `subagents/er-ie-diagram-agent.md`
- Grammar or regular expressions: `subagents/grammar-diagram-agent.md`
