...
- `subagents/architecture-doc-writer.md`: create or update system, service, module, integration, and decision documentation.
- `subagents/feature-doc-writer.md`: document product features, user behavior, acceptance criteria, API/UI behavior, and release notes.
- `subagents/flow-doc-writer.md`: document business flows, sequence flows, state transitions, async jobs, error paths, and operational runbooks.
- `subagents/database-doc-writer.md`: document database schema, tables, relations, indexes, migrations, retention, and data ownership.
