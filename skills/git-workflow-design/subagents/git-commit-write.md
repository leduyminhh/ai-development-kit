...
- Keep the body short, focused on the main point, and grouped by functional changes.
...
- Long commit bodies with background narration, repeated file lists, or ungrouped low-level details.
...
- structured Vietnamese body:
  - `Why:` one short bullet in Vietnamese with diacritics
  - `What:` one or two short bullets grouped by functional change
