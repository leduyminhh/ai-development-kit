...
const CASES = [
  ...
  ["application", "application.plan_feature", { featureGoal: "Add checkout confirmation", sourceScope: "services/checkout and web" }, ["featureContext", "stackMap", "dependencyGraph", "acceptanceGates"], "featureGoal"],
  ["application", "application.design_api_contract", { featureContext: "checkout confirmation", consumerProviderScope: "React to checkout API" }, ["operations", "schemas", "errorModel", "compatibilityChecks"], "featureContext"],
  ["application", "application.design_data_change", { featureContext: "checkout confirmation", currentDataContract: "orders v1" }, ["schemaChanges", "migrationStages", "rollbackPlan", "dataGates"], "currentDataContract"],
  ["application", "application.implement_backend", { featureContext: "approved checkout feature", backendScope: "services/checkout" }, ["selectedStack", "changedBehavior", "changedFiles", "verification"], "backendScope"],
  ["application", "application.implement_frontend", { featureContext: "approved checkout feature", frontendScope: "web" }, ["implementedFlow", "apiIntegration", "uxStates", "verification"], "frontendScope"],
  ["application", "application.integrate_feature", { featureContext: "checkout feature", implementationArtifacts: "backend and frontend summaries" }, ["integrationMap", "contractMismatches", "verification", "blockedGates"], "implementationArtifacts"],
  ["application", "application.review_feature", { featureContext: "checkout feature", changedFileScope: "checkout diff" }, ["criticalFindings", "majorFindings", "testGaps", "residualRisk"], "changedFileScope"],
  ["application", "application.test_feature", { featureContext: "checkout feature", changedFileScope: "checkout diff" }, ["testMatrix", "executedTests", "failures", "exitCriteria"], "featureContext"],
  ["application", "application.fix_feature", { selectedFindings: "CHK-001", approvedSourceScope: "services/checkout" }, ["fixedFindings", "changedFiles", "verification", "unresolvedFindings"], "selectedFindings"],
  ["application", "application.deliver_feature", { featureGoal: "Add checkout confirmation", sourceScope: "services/checkout and web" }, ["phaseStatus", "artifacts", "verification", "releaseReadiness"], "sourceScope"],
