...
const CASES = [
  ...
  ["application", "application.review_source_code", { sourceSummary: "Spring checkout service", reviewGoal: "maintainability" }, ["findings", "refactoringActions", "testGaps"], "sourceSummary"],
  ["application", "application.generate_service", { serviceGoal: "payment orchestration", technicalContext: "Node.js and PostgreSQL" }, ["components", "implementationSteps", "contracts", "verification"], "serviceGoal"],
  ["application", "application.review_api", { apiContract: "POST /orders", reviewGoal: "backward compatibility" }, ["findings", "compatibilityRisks", "recommendations", "tests"], "apiContract"],
