...
'@
    ...
    & powershell -NoProfile -ExecutionPolicy Bypass -File $validator -Root $tempRoot -PathList '.codex/agents/java-review.toml|.codex/agents/code-design-pattern.toml|.agents/skills/java-review/SKILL.md|.agents/skills/java-review/subagents/java-api-contract-review.md|.codex/hooks/validate-workflow.ps1|scripts/run-workflow-validate.ps1|.agents/skills/workflow-validate/scripts/validate-workflow.ps1|.agents/skills/diagram-wireframe-generate/SKILL.md|.agents/skills/test-automation-validate/SKILL.md|.agents/skills/java-analyze/SKILL.md|.agents/skills/architecture-onion-design/SKILL.md|.agents/skills/code-design-pattern/SKILL.md' | Out-Null
    Assert-True ($LASTEXITCODE -eq 0) 'Naming validator should pass valid agent, skill, subagent, hook, and script names.'
