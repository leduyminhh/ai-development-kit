...
Source taxonomy: Baeldung Code Design Patterns Series, which organizes patterns into Creational, Structural, Behavioral, and Other Architectural Patterns.
...
5. Before applying a pattern, present a concise decision note:
   - `Pattern Ä‘Æ°á»£c Ä‘á» xuáº¥t:`
   - `CÆ¡ sá»Ÿ lá»±a chá»n:`
   - `Rá»§i ro náº¿u Ã¡p dá»¥ng khÃ´ng phÃ¹ há»£p:`
   - `YÃªu cáº§u phÃª duyá»‡t: vui lÃ²ng xÃ¡c nháº­n trÆ°á»›c khi triá»ƒn khai.`
...
- Priority 1 when object creation is the problem: `subagents/pattern-creation-generate.md`
...
- Priority 1 when application boundary or distributed flow is the problem: `subagents/pattern-architecture-design.md`
...
Files changed:
Verification:
Rá»§i ro / khuyáº¿n nghá»‹ tiáº¿p theo:
```
